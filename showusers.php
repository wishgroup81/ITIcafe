      ...
      <div class="container">
        <div class="row">
          <div class="tm-top-header-inner">
            ...
            <nav class="tm-nav">
              <ul class="nav">
                <li><a href="#" class="active nav-link"> users</a></li>
                <li><a href="./addusers.php" class="nav-link">Add User</a></li>
            ...
            <tbody>
                <?php foreach ($users as $user) : ?>
                    <tr >
                        ...
                        <td>
                            <a  class="btn btn-info" href='./edituserform.php?id=<?php echo ($user['id']);?>'>edit</a> 
